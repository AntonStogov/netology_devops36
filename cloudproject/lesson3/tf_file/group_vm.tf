...
#!/bin/bash
cd /var/www/html
echo '<html><head><title>Picture happy new year</title></head> <body><h1>Happy new year</h1><img src="http://${yandex_storage_bucket.sysad.bucket_domain_name}/happy_new_year.jpg"/></body></html>' > index.html
EOF
    }
  }
